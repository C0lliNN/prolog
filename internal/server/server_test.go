...
func testConsumePastBoundary(t *testing.T, client api.LogClient, _ api.LogClient, _ *Config) {
	ctx := context.Background()
...
func testProduceConsumeStream(t *testing.T, client api.LogClient, _ api.LogClient, _ *Config) {
	ctx := context.Background()
